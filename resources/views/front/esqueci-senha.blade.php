        ...
        <div class="hero min-h-screen col-span-8 bg-base-200 p-0 m-0">
            <div class="hero-content flex-col lg:flex-row-reverse">
                <div class="text-center lg:text-left">
                    <h1 class="text-5xl font-bold text-orange-700 content-start">Renovar senha!</h1>
                    <div class="divider"></div>
                    <p class="pb-8 text-gray-200">Por favor forneça os dados solicitados e um email de recuperação será enviado.</p>
                    <span class="text-gray-200 py-4 pr-2">Já está tudo ok?</span>
                ...
                <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form class="card-body" action="{{route('solicitar-senha')}}" method="POST">
                        @method('POST')
                        @csrf
